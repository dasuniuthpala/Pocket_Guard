...
class profileFragment : Fragment() {
    ...
    private val restoreLauncher = registerForActivityResult(
        ...
        uri?.let { selectedUri ->
            if (backupRestoreUtil.restoreFromJson(selectedUri)) {
                ...
                loadUserSettings() // Reload settings from restored data
            } else {
    ...
    private fun loadUserSettings() {
        ...
        val currencyPosition = currencies.indexOf(sharedPrefsManager.getCurrency())
        ...
        darkModeSwitch.isChecked = sharedPrefsManager.isDarkModeEnabled()
        
        // Set threshold seekbar
    ...
    private fun setupListeners() {
        ...
        darkModeSwitch.setOnCheckedChangeListener { _, isChecked ->
            sharedPrefsManager.setDarkMode(isChecked)
