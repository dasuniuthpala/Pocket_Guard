...
import com.example.finbot.fragment.homeFragment
...
import com.example.finbot.data.FinBotDatabase
import com.example.finbot.data.FinBotRepository
...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var repository: FinBotRepository
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val database = FinBotDatabase.getDatabase(applicationContext)
        repository = FinBotRepository(database.expenseDao(), database.earningDao())
